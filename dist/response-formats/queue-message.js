...
function formatQueueMessage(message, callback) {
    ...
    if (calls && calls[0])
        calls = parseInt(calls[0].substr(3), 10);
...
//# sourceMappingURL=queue-message.js.map